...
def create_question(question_text, days):
    ...
    the given number of `days` offest to now (negative for questions)
    published in the past, positive for questions in the future.'''
...
class QuestionIndexResultsTests(TestCase):
    ...
    def test_results_view_with_a_past_question(self):
        ...
        should display the results of the question.'''
        past_question = create_question(question_text='Past question.',
                                        days=-5)
